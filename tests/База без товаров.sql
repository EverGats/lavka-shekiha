...
INSERT INTO `otzivi` (`id`, `id_user`, `id_post`, `fio`, `telefon`, `date_time`, `date_time_format`, `moder`, `opisanie`) VALUES
(1, 0, 0, 'Андрей', '9528212121', '22.09.2021 17:14', '2021-10-01 17:14:40', 0, 'Очень замечательный магазин! Товар отправляют быстро!  Спасибо!'),
(2, 0, 0, 'Анастасия', '9528212121', '01.10.2021 17:35', '2021-10-01 17:35:41', 0, 'Первый раз сюда попала. Цены меня здесь очень порадовали. Заказ пришел вовремя, без всяких задержек. Теперь знаю где делать выгодные покупки, буду советовать своим друзьям.'),
(3, 0, 0, 'Анастасия', '9384172395', '29.10.2021 15:20', '2021-10-29 15:20:44', 0, 'Посетила Ваш магазин, хожу за ароматами только к вам. И наконец попала в смену прекрасного продавца- консультанта Надежды. Очень отзывчивый , внимательный консультант. Всегда расскажет о новинках, очень грамотно подходит к подбору желаемого. Спасибо! Очень приятно , Надежда профессионал своего дела&amp;#127802;.');
