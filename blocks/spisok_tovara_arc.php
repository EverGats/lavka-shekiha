...
if ($_GET['filters']==1){echo"<div><a href='../katalog/?filters=2'><img src='../img/filters.png' width='25' height='25' align='top' border='0' style='margin-top:-2px;'/>&nbsp;Скрыть фильтры</a></div>";}
if ($_GET['filters']==2 || !$_GET['filters']){echo"<div><a href='../katalog/?filters=1'><img src='../img/filters.png' width='25' height='25' align='top' border='0' style='margin-top:-2px;'/>&nbsp;Показать фильтры</a></div>";}
...
//////////////////////////////////////////////////////////
$result_po_ml = mysql_query ("SELECT * FROM tovari_po_ml WHERE id_tovar='$myrow_all_stat[id]' ORDER by name DESC");
