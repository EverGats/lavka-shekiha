...
while($brand = $result->fetch_assoc()){
    ...
    if($check_result->num_rows > 0){
        echo("<div class='brand-item' style='text-align: center; font-size: 35px; font-weight: 500'><a style='text-decoration: none;' href='/catalog/brands/".$brand_seo_url."'>".strtoupper($brand_name)."</a></div>");  // Тут мы добавляем ссылку
    }
}
